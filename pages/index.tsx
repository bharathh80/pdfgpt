...
export default function Home() {
  ...
  return (
    <>
      <Layout >
        <div >
          <Image src='/Consulting.png' width='200' height='300' alt='Banner' className={styles.banner}/>
        </div>
        <div className="mx-auto flex flex-col gap-4">

          <h3 className={styles.bannertext}>
            Hi! I am Finn. I am an AI-powered chatbot. I have available to me the Thoughtworks annual reports of the financial years of 2021 and 2022. 
            You can ask me questions in English and other languages about the financial information that we reported during these financial years. 
